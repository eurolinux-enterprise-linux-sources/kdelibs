...
# fix bigendian issue on s390(x)
Patch53: kdelibs-4.3.4-kjs-s390-bz#698286.patch
...
Patch303: kdelibs-4.3.4-CVE-2011-3365-kssl.patch
...
%define x_deps libSM-devel libXcomposite-devel libXdamage-devel libxkbfile-devel libXpm-devel libXScrnSaver-devel libXtst-devel libXv-devel libXxf86misc-devel libXdmcp-devel
...
%patch303 -p1 -b .CVE-2011-3365-kssl
...
%patch401 -p1 -b .bz#682611
%patch402 -p1 -b .bz#734734
%patch404 -p1 -b .bz#826114
%patch405 -p1 -b .bz#754161
%patch406 -p1 -b .bz#882895
...
* Thu Oct 18 2012 Than Ngo <than@redhat.com> - 6:4.3.4-19
- fix multilib conflict

* Wed Oct 17 2012 Than Ngo <than@redhat.com> - 6:4.3.4-18
- Resolves: bz#866230, CVE-2012-4512 CVE-2012-4513

* Fri Sep 07 2012 Than Ngo <than@redhat.com> - 4.3.4-17
- Resolves: bz#754161, bz#587016, bz#682611, bz#734734, bz#826114, respin

* Tue Aug 28 2012 Than Ngo <than@redhat.com> - 6:4.3.4-16
- Resolves: bz#754161, stop/warn when a subdir is not accessible when copying

* Wed Aug 22 2012 Than Ngo <than@redhat.com> - 6:4.3.4-15
...
* Thu Feb 02 2012 Than Ngo <than@redhat.com> - 6:4.3.4-14
- Resolves: bz#698286, big endian issue on s390(x)

* Fri Oct 07 2011 Jaroslav Reznik <jreznik@redhat.com> - 6:4.3.4-13
- Resolves: bz#734446, use ca-certificates' ca-bundle.crt

* Wed Oct 05 2011 Jaroslav Reznik <jreznik@redhat.com> - 6:4.3.4-12
- Resolves: bz#743516, CVE-2011-3365 - input validation failure

* Tue Apr 12 2011 Than Ngo <than@redhat.com> - 6:4.3.4-11
